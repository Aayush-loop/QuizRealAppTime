                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2 sm:col-span-1">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            ...
                            <label for="checkbox-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Option -1</label>
                        </div>
                    </div>

                    <div class="col-span-2 sm:col-span-1">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="checkbox-2" type="checkbox" value="" name="checkbox-2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label for="checkbox-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Option -2 </label>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            ...
                            <label for="checkbox-3" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Option -3 </label>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            ...
                            <label for="checkbox-4" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Option -4</label>
                        </div>
                    </div>
                </div>
